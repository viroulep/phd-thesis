...
La table~\ref{tab:topologie-hops} donne un comparatif avec des chiffres indicatifs. Nous pouvons constater que sur \emph{idchire} les bandes passantes distantes sont relativement similaires comparativement à la bande locale, qui est presque trois fois plus importante.
