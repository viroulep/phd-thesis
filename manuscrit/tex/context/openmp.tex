...
Le listing~\ref{lst:context:openmp:taskdep} donne un exemple de tâches avec dépendance, où la variable |foo| est initialisée puis affichée.
...
\begin{lstlisting}[language=c++,caption=Vectorisation d'une opération complexes sur des tableaux,label=lst:context:openmp:simd]
#define N 1000000
float x[N][N], y[N][N];
#pragma omp parallel
{
