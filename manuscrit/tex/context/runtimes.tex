...
Au contraire des algorithmes de listes gloutons, le vol de travail peut fonctionner de manière totalement décentralisé, avec un nombre arbitraire de files de tâches.
