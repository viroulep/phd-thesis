...
On constate donc qu'il y a deux moments clés où le thread doit prendre une décision importante : le choix de la queue pour l'ajout des nouvelles tâches prêtes, et le choix de la victime pour le vol.
