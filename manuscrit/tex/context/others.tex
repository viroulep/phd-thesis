...
\begin{todo}
  agrandir cette partie, illustrer avec des chiffres.
  La granularité peut s'illustrer via un cholesky dont on fait varier la taille de bloc sur nombre de cpu fixé.
  3 facteurs : structures de données (queue unique vs queue distribuée), coût de création de tâches, affinité (probablement dans une moindre mesure en choisissant pas trop de threads).
\end{todo}
...
TODO ouvrir sur techniques d'ordonnancement.
