...
Ces extensions ont été implémentées dans le compilateur Clang~\footnote{https://gitlab.inria.fr/openmp/clang}. Afin de pouvoir utiliser les informations fournies par le programmeur, nous avons également du étendre le support exécutif~: les modifications effectuées sont décrites dans la section suivante.
