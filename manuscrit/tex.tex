...
\part{Getting to know NUMA architectures internals}
...
\chapter{Understanding NUMA architecture}\label{chap:contrib:characterization}
\chaptertoc
...
\section{Performances model/Simulation}
...
\subsection{What is missing, can we do more ?}
...
\chapter{KASTORS}\label{chap:exp:kastors}
\chaptertoc


\section{Motivation}
\section{Kernels description}
