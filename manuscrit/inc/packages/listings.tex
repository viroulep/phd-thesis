...
%	linewidth=0.95\textwidth,
	...
	numbersep=5pt,
% OMP define
emph={\#,pragma, taskwait, omp, for, num_threads, schedule, parallel, task, target, map, depend, affinity,init}, emphstyle=\color{RoyalBlue}\bfseries,
emph={[2]in,inout,out,cw,data,node,thread, random, cyclic, cyclicnuma, tofrom}, emphstyle={[2]\color{BrickRed}\bfseries},
