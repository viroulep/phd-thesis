...
Like proposed in \cite{Olivier:2012:CMW:2388996.2389085}, all these strategies comes in two versions : a \verb!strict! version in which we prevent processors to steal from other NUMA nodes to improve data locality, and a \verb!loose! version where these restrictions do not apply.
