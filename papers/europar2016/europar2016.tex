...
\author{
  Philippe Virouleau$^{1,2,3}$ \and François Broquedis$^4$ \and Thierry Gautier$^{1,5}$
 \vspace*{-1ex}}
\institute{
   $^1$Inria,
...
runtime to have very precise information about which part of an application
needs which data~: thanks to these dependencies, it is known which data blocks are read,
written, or both, and by which task.
The runtime has a lot of freedom in its scheduling strategies. This work aims
