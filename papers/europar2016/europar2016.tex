...
We also made our execution log files public\footnote{TODO}, as well as all the scripts we used, so that
...
horizontal line is the \kaapi performance baseline using \verb/numactl/.
