...
\section{Plan (bof! idées quoi...)}

\subsection{Le modèle d'exécution par vol de tâches}
\subsubsection{Inside kaapi}
\begin{itemize}
\item des trucs très simples sur le fonctionnement interne d'un
  runtime data-flow.
\end{itemize}
\subsubsection{notre façon de voir la machine}
\begin{itemize}
\item places (kproc, NUMA) ;
\item impact du placement sur l'exécution / le vol (pop, steal, blabla)
\end{itemize}

\subsubsection{On pose le problème}
\begin{itemize}
