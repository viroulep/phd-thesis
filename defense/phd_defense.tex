...
TODO : point état de l'art (Olivier (vol hiérarchique), ForestGOMP (placement de tâche "proches" et migration de données), OpenStream (distribution, placement en fonction des buffers)))
