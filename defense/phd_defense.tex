...
\frametitle{Contexte}
  ...
  \begin{figure}
    \includegraphics[width=\textwidth]{graph/simulation.pdf}
  \end{figure}
...
\frametitle{Contexte}
  Un supercalculateur 
  \uncover<2> {
    = plusieurs centaines (milliers) de noeuds !
  }
  \begin{figure}
    \only<1>{%
...
\frametitle{Contexte}
  ...
  \begin{figure}
    \only<1>{%
      \includegraphics[width=0.9\textwidth]{graph/anim-peag/peage-analogie.pdf}%
    }%
    \only<2>{%
      \includegraphics[width=0.9\textwidth]{graph/anim-peag/peage-analogie1.pdf}%
    }%
    \only<3>{%
      \includegraphics[width=0.9\textwidth]{graph/anim-peag/peage-analogie2.pdf}%
    }%
    \only<4>{%
      \includegraphics[width=0.9\textwidth]{graph/anim-peag/peage-analogie3.pdf}%
    }%
    \only<5>{%
      \includegraphics[width=0.9\textwidth]{graph/anim-peag/peage-analogie4.pdf}%
    }%
    \only<6>{%
      \includegraphics[width=0.9\textwidth]{graph/anim-peag/peage-analogie5.pdf}%
    }%
    \only<7>{%
      \includegraphics[width=0.9\textwidth]{graph/anim-peag/peage-analogie6.pdf}%
    }%
    \only<8>{%
      \includegraphics[width=0.9\textwidth]{graph/anim-peag/peage-analogie7.pdf}%
    }%
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  Exécution via libKOMP sur une machine à 192 coeurs.
...
\begin{frame}
  ...
  \begin{block}{Questions en suspens}
    \begin{itemize}
...
\begin{frame}
\frametitle{Approches existantes}
...
\begin{frame}
  ...
  \uncover<2>{
    \begin{block}{Intuition générale}
      %Affinité assez simple à mettre en place,
      rentable lorsque les dataset manipulés par les tâches sortent du L3.
    \end{block}
  }
\end{frame}
