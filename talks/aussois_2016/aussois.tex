...
%-> Changer/Contrôler le placement des tâches sur la machines, tout en respectant les dépendances
%-> implique un contrôle possible de l'initialisation
...
%\subsection{Objectives overview}
...
%\begin{frame}
%\frametitle{Support exécutif - placement d'une tâche}
%\only<1> {
  %\begin{figure}
    %\includegraphics[width=\textwidth]{graph/push_1.pdf}
  %\end{figure}
%}
%\only<2> {
  %\begin{figure}
    %\includegraphics[width=\textwidth]{graph/push_2.pdf}
  %\end{figure}
%}
%\end{frame}
...
%\begin{frame}
%\frametitle{Support exécutif - placement d'une tâche}
%Exemple de stratégie hiérarchique
    %\begin{figure}
        %\includegraphics[width=\textwidth]{graph/strategies.pdf}
    %\end{figure}

%\end{frame}

%L'implémentation de ces algos
